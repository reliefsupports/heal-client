...
import sin from "../../assets/i18n/sin.json";
import ta from "../../assets/i18n/ta.json";
import { InputGroup, InputGroupAddon, Button } from "reactstrap";

setTranslations({ en, es, pt, fr, du, cn, ae, sin, ta });
          ...
          <li className="language-nav">
            ...
            >
              ...
              <div className={`more_lang ${langdropdown ? "active" : ""}`}>
                ...
                <div className="lang" onClick={() => handleSetLanguage("sin")}>
                  <i className="flag-icon flag-icon-lk"></i>
                  <span className="lang-txt">{Sinhala}</span>
                </div>
                <div className="lang" onClick={() => handleSetLanguage("ta")}>
                  <i className="flag-icon flag-icon-lk"></i>
                  <span className="lang-txt">{Tamil}</span>
                </div>
          ...
          {/* <li className="cart-nav onhover-dropdown">
            ...
            >
              ...
              <li>
                ...
                <Button color="secondary" className="btn-block view-cart mt-2">
                  {CheckOut}
                </Button>
              </li>
            </ul>
