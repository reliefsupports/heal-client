  ...
  const handleLogin = async (e) => {
    ...
    try {
      localStorage.setItem(
        "token",
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IkpvaG4iLCJwYXNzd29yZCI6IjEyMzQ1NiJ9.vPN0PhthyTuf9l3912NksmpzHXvWjZ7Nywhe22GK2zI"
      );
      setTimeout(() => {
    ...
    <Container fluid={true}>
      <Row>
        <Col
          ...
          style={{
            backgroundImage: `url(${require("../../assets/images/Help_BG.jpeg")})`,
        ...
        >
          <img
            ...
            style={{ display: "none" }}
            src={require("../../assets/images/Help_BG.jpeg")}
            alt="looginpage"
          />
        </Col>
                ...
                <TabContent activeTab={selected} className="content-login">
                  ...
                  >
                    <div className="text-center">
                      <h2 className="title-name mb-4">Heal</h2>
                    </div>
